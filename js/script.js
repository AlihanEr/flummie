...
// Gallery Filter (only if gallery exists on page)
...
// Lightbox Functionality (only if lightbox exists on page)
...
// Initialize with saved or default language on page load
document.addEventListener('DOMContentLoaded', () => {
